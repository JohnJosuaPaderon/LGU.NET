...
namespace LGU.EntityProcesses.HumanResource
{
    public sealed class InsertEmployeeFingerPrintSet : HumanResourceProcessBase, IInsertEmployeeFingerPrintSet
    {
        ...
        private SqlQueryInfo<EmployeeFingerPrintSet> QueryInfo
        {
            get
            {
                return SqlQueryInfo<EmployeeFingerPrintSet>.CreateProcedureQueryInfo(FingerPrintSet, GetQualifiedDbObjectName("InsertEmployeeFingerPrintSet"), GetProcessResult, true)
