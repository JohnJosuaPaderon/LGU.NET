...
namespace LGU.EntityProcesses.HumanResource
{
    public sealed class UpdateEmployeeFingerPrintSet : EmployeeFingerPrintSetProcess, IUpdateEmployeeFingerPrintSet
    {
        ...
        private SqlQueryInfo<EmployeeFingerPrintSet> QueryInfo =>
            SqlQueryInfo<EmployeeFingerPrintSet>.CreateProcedureQueryInfo(FingerPrintSet, GetQualifiedDbObjectName("UpdateEmployeeFingerPrintSet"), GetProcessResult, true)
