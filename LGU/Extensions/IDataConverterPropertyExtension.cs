...
namespace LGU.Extensions
{
    public static class IDataConverterPropertyExtension
    {
        ...
        public static TResult TryGetValueFromProcess<TResult, TArg>(this IDataConverterProperty<TResult> instance, Func<TArg, IProcessResult<TResult>> getDataById, Func<string, TArg> getIdFromReader, string idField)
        {
