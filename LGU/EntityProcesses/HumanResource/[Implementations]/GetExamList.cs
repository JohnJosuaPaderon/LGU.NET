...
namespace LGU.EntityProcesses.HumanResource
{
    public sealed class GetExamList : ExamProcess, IGetExamList
    {
        ...
        public IEnumerableProcessResult<Exam> Execute()
        {
            return r_SqlHelper.ExecuteReaderEnumerable(QueryInfo, r_Converter);
        }

        public Task<IEnumerableProcessResult<Exam>> ExecuteAsync()
        {
            return r_SqlHelper.ExecuteReaderEnumerableAsync(QueryInfo, r_Converter);
        }

        public Task<IEnumerableProcessResult<Exam>> ExecuteAsync(CancellationToken cancellationToken)
        {
