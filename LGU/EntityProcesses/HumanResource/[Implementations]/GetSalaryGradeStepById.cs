...
namespace LGU.EntityProcesses.HumanResource
{
    ...
    {
        public GetSalaryGradeStepById(IConnectionStringSource connectionStringSource, ISalaryGradeStepConverter<SqlDataReader> converter) : base(connectionStringSource, converter)
        {
        }
