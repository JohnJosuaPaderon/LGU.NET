...
namespace LGU.EntityProcesses.HumanResource
{
    ...
    {
        public GetTimeLogListByEmployeeCutOff(IConnectionStringSource connectionStringSource, ITimeLogConverter converter) : base(connectionStringSource, converter)
        {
        }
