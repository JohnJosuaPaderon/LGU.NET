...
namespace LGU.EntityProcesses.HumanResource
{
    ...
    {
        public DeleteSalaryGradeBatch(IConnectionStringSource connectionStringSource, ISalaryGradeBatchConverter converter) : base(connectionStringSource, converter)
        {
        }
