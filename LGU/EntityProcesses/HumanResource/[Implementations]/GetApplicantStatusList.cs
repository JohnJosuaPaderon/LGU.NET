...
namespace LGU.EntityProcesses.HumanResource
{
    public sealed class GetApplicantStatusList : ApplicantStatusProcess, IGetApplicantStatusList
    {
        ...
        public IEnumerableProcessResult<ApplicantStatus> Execute()
        {
            return r_SqlHelper.ExecuteReaderEnumerable(QueryInfo, r_Converter);
        }

        public Task<IEnumerableProcessResult<ApplicantStatus>> ExecuteAsync()
        {
            return r_SqlHelper.ExecuteReaderEnumerableAsync(QueryInfo, r_Converter);
        }

        public Task<IEnumerableProcessResult<ApplicantStatus>> ExecuteAsync(CancellationToken cancellationToken)
        {
