...
namespace LGU.EntityProcesses.HumanResource
{
    public sealed class GetLocatorList : LocatorProcess, IGetLocatorList
    {
        ...
        public IEnumerableProcessResult<Locator> Execute()
        {
            return r_SqlHelper.ExecuteReaderEnumerable(QueryInfo, r_Converter);
        }

        public Task<IEnumerableProcessResult<Locator>> ExecuteAsync()
        {
            return r_SqlHelper.ExecuteReaderEnumerableAsync(QueryInfo, r_Converter);
        }

        public Task<IEnumerableProcessResult<Locator>> ExecuteAsync(CancellationToken cancellationToken)
        {
